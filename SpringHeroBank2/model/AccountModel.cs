...
//            cmd.Parameters.AddWithValue("@status", account.Status);
        ...
        public List<Transaction> getTransactionList()
        {
            ...
            while (reader.Read())
            {
                ...
                var createdAt = reader.GetString("createdAt");
                var type = (Transaction.TransactionType) reader.GetInt32("type");
                ...
                var status = (Transaction.ActiveStatus) reader.GetInt32("status");
                transaction = new Transaction(id, createdAt, type, amount,content,
        ...
        public void printList(List<Transaction> listTransactions)
        {
            Console.WriteLine("{0,40}|{1,20}|{2,18}|{3,35}|{4,35}|{5,15}",
                "Transaction ID", "Date", "Transaction Type", "ReceiverAccount", "Content", "Amount");
