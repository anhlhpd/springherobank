namespace SpringHeroBank.entity
{
    public class Transaction
    {
        ...
        public Transaction(string id, string createdAt, TransactionType type, decimal amount, string content, string receiverAccountNumber)
        {
            _id = id;
            _createdAt = createdAt;
            _type = type;
        ...
        public Transaction(string id, string createdAt, TransactionType type, decimal amount, string content, string senderAccountNumber, string receiverAccountNumber, ActiveStatus status)
        {
            _id = id;
            _createdAt = createdAt;
            _type = type;
